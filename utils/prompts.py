CAVE_PAINTING = (
    ...
    "such as faded handprints, torchlight shadows, animals, or human figures to enhance the ancient, "
    "symbolic aesthetic. The artwork should feel raw and interpret the concept through the lens of early "
    "human storytelling."
)
